<resource schema="ogle" resdir=".">
  ...
  <STREAM id="ogle_meta">
    ...
    <meta name="instrument">Warsaw 1.3 m Telescope</meta>
  ...
  <STREAM id="longdoc_ogle">
    <meta name="_longdoc" format="rst">
      ...
      OCVS light curves span three survey phases: OGLE-II (1996–2000), OGLE-III (2001–2009),
      ...
      Cataclysmic Variables — CV, BLAPs, Anomalous Cepheids in the Milky Way — ACEP/GAL) or a specific 
      ...
      ADQL Query Examples:
        ...
        1. Download all RR Lyrae light curves with period in [0.5–0.7 days]
        range in the I band:
        ...
        2. Download all previews of the light curves with epochs (time of
        maximum brightness) in the future:
        SELECT * from ogle.objects_all WHERE epoch > ivo_to_mjd('2027-01-01')

        3. Find all stars with periods longer than the duration of observations
        in I filter:
        ...
        4. Select ten eclipsing binary systems, classified as "Contact" with
        the longest periods:
